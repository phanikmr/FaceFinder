...
% Last Modified by GUIDE v2.5 04-Oct-2013 22:53:33
...
%set(handles.link,'String',{'<html>FOR MORE HELP:<a href="http://phanimatlabapps.blogspot.in/"http://phanimatlabapps.blogspot.in/</a></html>'});
%set(handles.link,'String',{'<HTML><FONT color = "red">Hello</Font></html>'});
imshow('splash.png');
